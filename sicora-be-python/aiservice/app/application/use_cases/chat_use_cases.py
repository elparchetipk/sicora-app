...
from app.domain.value_objects.ai_prompt import AIPrompt, PromptTemplate
...
class ChatUseCase:
    ...
    async def create_conversation(self, request: ConversationCreateDTO) -> ConversationResponseDTO:
    ...
    async def get_conversation(self, conversation_id: UUID, user_id: UUID) -> ConversationResponseDTO:
    ...
    async def list_conversations(
        ...
        for conversation in conversations:
            ...
            result.append(ConversationResponseDTO(
                conversation_id=conversation.conversation_id,
                user_id=conversation.user_id,
                title=conversation.title,
                message_count=conversation.get_messages_count(),
        ...
        try:
            ...
            if similar_entries:
                ...
                if messages:
                    ...
                    last_message.add_metadata("knowledge_sources", [
