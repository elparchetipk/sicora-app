...
class PromptTemplate(str, Enum):
    ...
    SENA_COORDINATOR = "sena_coordinator"
...
class AIPrompt:
    ...
    def from_template(cls, template: PromptTemplate, variables: Optional[Dict[str, Any]] = None) -> "AIPrompt":
        ...
        templates = {
            ...
            PromptTemplate.SENA_COORDINATOR: {
                "content": "Eres un coordinador académico del SENA especializado en {program}. Asiste con {query}.",
                "prompt_type": PromptType.INSTRUCTION,
                "context": "SENA - Servicio Nacional de Aprendizaje, Colombia",
                "instructions": "Proporciona información precisa sobre programas, procesos y normativas del SENA."
            },
