...
type UserRepository interface {
	...
	GetByDocumento(ctx context.Context, documento string) (*entities.User, error)
	...
	// ExistsByDocumento verifica si existe un usuario con el documento dado
	ExistsByDocumento(ctx context.Context, documento string) (bool, error)
